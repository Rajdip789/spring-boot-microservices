...
import static com.rajdip14.ecommerce.email.EmailTemplates.*;
...
public class EmailService {
    ...
    @Async
    public void sendPaymentUpdateEmail(
        ...
        messageHelper.setFrom("palrajdip14@gmail.com");
        ...
        try {
            ...
            log.warn("WARNING - Cannot send Payment update Email to {} ", destinationEmail);
        }
    }
    ...
    public void sendOrderUpdateEmail(
        ...
        Context context = new Context();
        context.setVariables(variables);
        messageHelper.setSubject(ORDER_NOTIFICATION.getSubject());
        ...
        try {
            ...
            log.warn("WARNING - Cannot send Order update Email to {} ", destinationEmail);
        }
